  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (
        ...
        !slidingWindowRef.current.contains(event.target)
      ) {
    ...
    <>
      <nav className={styles.navbar}>
        {ComponentToRender ? (
          <>
            <li className={styles.link}>
              <a onClick={() => navigate("/")}>
                ...
                <span className={styles.circle} data-color="title">
                  1
                </span>
          ...
          <>
            <li className={styles.link}>
              <a onClick={() => navigate("/manual")}>
                How it works & About
                <span className={styles.circle} data-color="how-it-works">
                  B
                </span>
                <span className={styles.line}></span>
              </a>
        ...
        <li className={styles.link}>
          <a onClick={() => toggleSlidingWindow("", "SignIn")}>
            <span className={styles.circle} data-color="sign-in">
              A
            </span>
            Sign in
          </a>
      ...
      <div ref={slidingWindowRef}>
        <SlidingWindow
          ...
          onClose={() => setSlidingWindowVisible(false)}
